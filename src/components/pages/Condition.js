...
class Condition extends React.Component {
  ...
  render() {
		...
		if (this.state.selectedRecipeId!=='') {
			return <Redirect to={'/Recipes/single/'+this.state.selectedRecipeId+'/'+this.state.selectedCondition.nutrientConstraints} />
		}

		if (this.state.redirectToSearch) {
			return <Redirect to={'/Recipes/Search/'+this.state.selectedCondition.nutrientConstraints} />
		}
